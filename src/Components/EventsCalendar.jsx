    ...
    <div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow-lg">
      ...
      <div className="mb-4 flex items-center justify-between">
        <button
          ...
          className="px-3 py-1 text-violet-600 hover:bg-violet-100 rounded"
        >
          &lsaquo;
        </button>
        ...
        {cells.map((day, index) => {
          ...
          return (
            ...
            >
              ...
              {dayEvents.length > 0 && (
                <span
                  className={`absolute bottom-1 h-1.5 w-1.5 rounded-full ${isSelected ? "bg-white" : "bg-violet-600"}`}
                />
              )}
            </button>
          );
      ...
      {selectedDay && (
        <div className="mt-5 border-t pt-4">
          <h3 className="mb-2 text-sm font-semibold text-gray-900">
            Events on {currentDate.toLocaleString("default", { month: "long" })}{" "}
            {selectedDay}, {year}
          </h3>
