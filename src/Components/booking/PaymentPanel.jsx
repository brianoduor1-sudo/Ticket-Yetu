  ...
  return (
    <form className="booking-card" onSubmit={handlePay}>
      ...
      >
        <button
          type="button"
          className={`chip ${method === "mpesa" ? "active" : ""}`}
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button
            type="button"
            className={`chip ${devOutcome === "success" ? "active" : ""}`}
            style={{ fontSize: 11, padding: "5px 10px" }}
            onClick={() => setDevOutcome("success")}
          >
            Success
          </button>
          <button
            type="button"
            className={`chip ${devOutcome === "decline" ? "active" : ""}`}
            style={{ fontSize: 11, padding: "5px 10px" }}
            onClick={() => setDevOutcome("decline")}
          >
            Decline
          </button>
        </div>
